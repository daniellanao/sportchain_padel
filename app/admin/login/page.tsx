...
export default async function AdminLoginPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="flex w-full min-h-0 flex-1 flex-col items-center justify-center px-4 py-10 sm:px-6 sm:py-16">
      <div className="w-full max-w-sm rounded-xl border border-foreground/10 bg-surface p-6 shadow-lg sm:p-8">
