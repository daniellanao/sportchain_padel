...
export default async function AdminOrganizersPage({ searchParams }: PageProps) {
  ...
  const listResult = await fetchOrganizersListFromSupabase();
  const organizers = listResult.organizers.map((o) => ({
    id: o.id,
    name: o.name,
    slug: o.slug,
    image: o.image,
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12">
        <div className="mb-8 flex flex-col items-center gap-6 text-center">
          <h1 className="logo text-2xl text-primary sm:text-3xl">Organizadores</h1>
